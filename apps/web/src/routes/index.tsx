  ...
  return (
    <Link
      ...
      style={{
        ...
        borderRadius: "16px", border: `1px solid rgba(45,190,127,0.2)`,
        background: CARD, textDecoration: "none", cursor: "pointer",
    ...
    >
      <span style={{ fontSize: "10px", letterSpacing: "0.1em", color: "rgba(45,190,127,0.7)", fontFamily: "monospace" }}>{num}</span>
      <div style={{
        width: "40px", height: "40px", borderRadius: "10px", background: "rgba(45,190,127,0.15)",
        border: `1px solid rgba(45,190,127,0.35)`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px",
      }}>{icon}</div>
      <p style={{ margin: 0, fontSize: "16px", fontWeight: 700, color: TEXT, lineHeight: 1.2 }}>{title}</p>
      <p style={{ margin: 0, fontSize: "12px", fontWeight: 300, color: MUTED, lineHeight: 1.5 }}>{desc}</p>
...
function Home() {
  return (
    <main style={{ minHeight: "100vh", background: BG, padding: "40px 32px 40px", position: "relative", overflow: "hidden", boxSizing: "border-box" }}>
      <div style={{ position: "absolute", top: "-100px", right: "-100px", width: "380px", height: "380px", borderRadius: "50%", background: "radial-gradient(circle, rgba(45,190,127,0.12) 0%, transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "-60px", left: "-60px", width: "250px", height: "250px", borderRadius: "50%", background: "radial-gradient(circle, rgba(45,190,127,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />

      <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(45,190,127,0.1)", border: `1px solid rgba(45,190,127,0.3)`, borderRadius: "100px", padding: "5px 14px", marginBottom: "28px" }}>
        <span style={{ width: "7px", height: "7px", borderRadius: "50%", background: GREEN, boxShadow: `0 0 8px ${GREEN}`, display: "inline-block" }} />
        <span style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: GREEN }}>Centro de rehabilitación</span>
      </div>

      <h1 style={{ margin: "0 0 8px", fontSize: "clamp(36px, 8vw, 52px)", fontWeight: 700, lineHeight: 1.08, color: TEXT, letterSpacing: "-0.01em" }}>
        Bienvenido a<br /><span style={{ color: GREEN, fontStyle: "italic" }}>Kinescius</span>
      </h1>

      <p style={{ margin: "0 0 32px", fontSize: "14px", fontWeight: 300, letterSpacing: "0.04em", color: MUTED }}>Buenos Aires · Sistema de gestión</p>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "28px" }}>
        ...
        <span style={{ fontSize: "10px", letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(13,31,24,0.18)" }}>Kinescius © 2026</span>
      </div>
    </main>
  );
}
