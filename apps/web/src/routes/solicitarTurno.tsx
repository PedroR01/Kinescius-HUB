...
import { pageMainClass, heroSectionClass, formCardClass } from "@/lib/ks-page-styles";
...
function RouteComponent() {
  ...
  const { cartItems, cartCount, addToCart, removeFromCart, removePaidFromCart, isInCart } =
    useClassCart();
      ...
      <section className={heroSectionClass}>
        ...
        <p className="relative mt-3 text-[14px] font-medium text-white/90">
          ...
          <span className="mt-1 block text-[13px] font-light text-white/72">
            * En caso de ser abonado se le aplicará un 20% de descuento al pagar la totalidad de la
            clase presencialmente.
          </span>
        </p>
        <p className="relative mt-3 text-[14px] font-medium text-white/90">
